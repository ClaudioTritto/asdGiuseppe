...
public class WhatsupTest {
	private static String [] parole = {"Questa ", "� ", "una ", "prova ", "un ", " po' ", "pi� ", "lunga!", "Hai ", "capito ", "coglione? ", "Utlime due ", "stringhe"};
	public static void main(String[] args) {
		...
		System.out.println("La generazione degli indici � pseudocasuale quindi potrebbe essere che un'eccezione ItemALreadyPresent venga lanciata. Se dovesse avvenire rilanciare.");
